...
|----|--------|------|-------|
1| workload is spread over the whole team (one team member is often Xtimes more productive than the others... | 3 | All contributors have made significant commits in the codebase. (https://github.com/lalit10/SimplyClip/graphs/contributors) |
2| but nevertheless, here is a track record that everyone is contributing a lot)|3|https://github.com/lalit10/SimplyClip/pulse|
3| Number of commits|3|https://github.com/lalit10/SimplyClip/pulse|
4| Number of commits: by different people|3|https://github.com/lalit10/SimplyClip/pulse|
5| Issues reports: there are **many**|3|[Issues](https://github.com/lalit10/SimplyClip/issues)|
6|  issues are being  closed|3|[Closed Issues](https://github.com/lalit10/SimplyClip/issues?q=is%3Aissue+is%3Aclosed)|
7| DOI badge: exists |3|Present in [README](https://github.com/lalit10/SimplyClip/blob/main/README.md)|
8|Docs: doco generated , format not ugly|3 |https://github.com/lalit10/SimplyClip/tree/main/Docs|
9|Docs: what: point descriptions of each class/function (in isolation) |3|https://github.com/lalit10/SimplyClip#functions-descriptions|
10|Docs: how: for common use cases X,Y,Z mini-tutorials showing worked examples on how to do X,Y,Z |3| [Check the video in README.md](https://github.com/lalit10/SimplyClip/blob/main/README.md)|
11|Docs: why: docs tell a story, motivate the whole thing, deliver a punchline that makes you want to rush out and use the thing|3|[Section in README](https://github.com/lalit10/SimplyClip#use-case)|
12|Docs: short video, animated, hosted on your repo. That convinces people why they want to work on your code.|3|https://github.com/lalit10/SimplyClip/blob/main/Docs/video/SimplyClip_Full.mp4 | 
13| Use of version control tools|3|Git is used thoroughly through the project|
14| Use of  style checkers |3|https://github.com/lalit10/SimplyClip#style-checker-and-analyzer|
15| Use of code  formatters. |3|https://github.com/lalit10/SimplyClip#code-formatter|
16| Use of syntax checkers. | 3 |https://github.com/lalit10/SimplyClip#syntax-checker|
17| Use of code coverage |3|Used the Coverage tab in Chrome Developer Tool's to view the code coverage|
18| other automated analysis tools|3|We've written a few functional test cases and automated them. No other tools were required |
19| test cases exist|3|https://github.com/lalit10/SimplyClip/tree/main/test|
20| test cases are routinely executed|3|Since the development of an extension doesn't involve a build, the test cases must be executed routinely by the developers|
21| the files CONTRIBUTING.md lists coding standards and lots of tips on how to extend the system without screwing things up|3|https://github.com/lalit10/SimplyClip/blob/main/CONTRIBUTING.md|
22| issues are discussed before they are closed|2| Since all the contributors are roommates, we had a simple project group on WhatsApp. Whereas, most of the communication took place in-person. |
23| Chat channel: exists|3|https://chat.whatsapp.com/H3oexKzYt3dBqbJ2l7fUAt|
24| test cases:.a large proportion of the issues related to handling failing cases.| 1 |If a test case fails, people are encouraged to open an issue and fix it|
25| evidence that the whole team is using the same tools: everyone can get to all tools and files | 3 | Everyone has the same access to the repository and also have equal access to comitting directly to the main branch. |
26| evidence that the whole team is using the same tools (e.g. config files in the repo, updated by lots of different people)| 3 |[One such example of config file in the repository](https://github.com/lalit10/SimplyClip/blob/main/.eslintrc.js)|
27| evidence that the whole team is using the same tools (e.g. tutor can ask anyone to share screen, they demonstrate the system running on their computer)| 3 | https://github.com/lalit10/SimplyClip/graphs/contributors |
28| Evidence that the members of the team are working across multiple places in the code base | 3 | https://github.com/lalit10/SimplyClip/commits/main |
29| short release cycles | 3 |(hard to see in short projects) The Project members are committing often enough so that everyone can get your work|
30| Documentation provides clear overview of software and uses | 3 | https://github.com/lalit10/SimplyClip#simplyclip |
31| Website and documentation clearly describe the type of user who should use your software | 3 | https://github.com/lalit10/SimplyClip#simplyclip |
32| Case studies to show how software is used by us | 3 | Provided a video in the [README.md](https://github.com/lalit10/SimplyClip/blob/main/Docs/video/SimplyClip_Full.mp4) |
...
94| Source code files include a licence header | 3 | MIT License(https://github.com/lalit10/SimplyClip/blob/main/LICENSE) |
